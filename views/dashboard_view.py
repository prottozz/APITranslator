...
from utils import apply_shadow  # Import the shadow utility
import re
import os
...
class DashboardView(QWidget):
    ...
    def _init_ui(self):
        ...
        actions_row_layout.addWidget(self.start_button)
        actions_row_layout.addSpacing(20)
        ...
        self.last_successful_label.setStyleSheet("font-size: 8pt; color: #6b7280;")
